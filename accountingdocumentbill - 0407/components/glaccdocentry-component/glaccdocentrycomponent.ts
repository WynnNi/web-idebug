...
@Component({
  ...
  providers: [
    ...
    { provide: COMMAND_HANDLERS_TOKEN, useClass: CopyAccDocEntry1Handler, multi: true },
    { provide: COMMAND_HANDLERS_TOKEN, useClass: InsertAccDocEntry1Handler, multi: true },
    { provide: COMMAND_HANDLERS_TOKEN, useClass: MoveUpAccDocEntry1Handler, multi: true },
    { provide: COMMAND_HANDLERS_TOKEN, useClass: MoveDownAccDocEntry1Handler, multi: true },

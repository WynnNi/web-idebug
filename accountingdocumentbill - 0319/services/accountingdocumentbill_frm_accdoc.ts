...
export class AccDocService extends ListRepositoryService {
    ...
    total(accDocID: string): Observable<any> {
        ...
        this.frameContext.appContext.getFrameContext('glaccdocentry-component').uiState['TotalJF'] = sumJF;
        this.frameContext.appContext.getFrameContext('glaccdocentry-component').uiState['TotalDF'] = sumDF;
        this.frameContext.appContext.getFrameContext('glaccdocentry-component').uiState['Difference'] = sumJF - sumDF;

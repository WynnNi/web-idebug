...
export class CreateAccDocAssistant1Handler extends CommandHandler {
  ...
  schedule() {
    ...
    this.addTask('deleteAllAss', (context: CommandContext) => {
      const args = [
        '{COMMAND~/params/accDocID}',
        '{COMMAND~/params/entryID}',
        ''
      ];
      return this.invoke(this._AccDocAssistanceService1, 'deleteAllAss', args, context);
    });
    ...
    this.addLink('deleteAllAss', 'createAssistance', `1==1`);

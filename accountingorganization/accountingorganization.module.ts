...
import { AccountingOrganizationRoutingModule } from './routing';
...
import { FIAccountingSetComponent } from './components/fiaccountingset-component/fiaccountingsetcomponent';
...
@NgModule({
  ...
  imports: [
    ...
    AccountingOrganizationRoutingModule,
    EchartsModule
  ],
  providers: [
    ...
    FIAccountingOrganizationRepository

  ]
})
export class AccountingOrganizationModule {
  constructor() {}
}

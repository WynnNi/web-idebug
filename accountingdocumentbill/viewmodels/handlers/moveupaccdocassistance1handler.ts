...
@Injectable()
@NgCommandHandler({
  commandName: 'MoveUpAccDocAssistance1'
})
export class MoveUpAccDocAssistance1Handler extends CommandHandler {
  constructor(
  ...
  schedule() {
    ...
    this.addTask('moveUpAccDocAssistance1', (context: CommandContext) => {
      const args = [
      ...
      return this.invoke(this._AccDocAssistanceService1, 'moveUpAccDocAssistance', args, context);
    });
    ...
    this.addLink('moveUpAccDocAssistance1', 'assistanceAmount', `1==1`);
  }
